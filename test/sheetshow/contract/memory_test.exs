defmodule Sheetshow.Contract.MemoryTest do
  use ExUnit.Case, async: true

  # The backend contract over the in-memory spreadsheet. The checks live in
  # `Sheetshow.BackendContract`; this file only says which workbook to run them on.

  import Sheetshow.BackendContract

  setup do
    {:ok, workbook} = Sheetshow.connect(Sheetshow.Workbook.memory())
